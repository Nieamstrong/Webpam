...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar bg-gradient-primary sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- <?php if ($this->uri->segment('1') == 'admin_beranda') { ?>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url('admin_beranda'); ?>">
            ...
            <?php if ($this->uri->segment('1') == 'admin_masyarakat') { ?>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url('admin_masyarakat'); ?>">
                        <i class="fas fa-fw fa-user-alt"></i>
            ...
            <li class="nav-item active-sub">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?php echo base_url('admin_beranda'); ?>">Petugas</a>
                        <a class="collapse-item active" href="<?php echo base_url('admin_masyarakat'); ?>">Masyarakat</a>
                    </div>
                </div>
            </li>

            <?php if ($this->uri->segment('1') == 'admin_laporan') { ?>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url('admin_laporan'); ?>">
            ...
            <?php if ($this->uri->segment('1') == 'admin_reg') { ?>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url('admin_reg'); ?>">
                    <i class="fa-solid fa-user-plus" style="color: #27467c;"></i>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-dark">
                                    <h2><b><?php echo $nama->username; ?></b></h2>
                                </span>
                                <div class="topbar-divider d-none d-sm-block"></div>
                                <span class="mr-2 d-flex d-lg-inline text-gray-600 small">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span><i class="fa-brands fa-instagram"></i>Alienbrain</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary font-weight-bold" id="exampleModalLabel">Yakin Keluar?</h5>
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url('login/logoutApp') ?>">Keluar</a>
                </div>
            </div>
        </div>
    </div>
