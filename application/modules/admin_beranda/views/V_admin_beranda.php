                                ...
                                <div class="modal fade" id="demo-default-edit<?= $res->id_user; ?>" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?= form_open_multipart('admin_beranda/editpetugas'); ?>
                                            <!--Modal body-->
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6" style="margin-top: 2% ">
                                                            ...
                                                            <select name="level" required="" class="form-control">
                                                                <option <?php echo ($res->level == '1') ? "selected" : "" ?> value="1">Admin
                                                                </option>
                                                                <option <?php echo ($res->level == '2') ? "selected" : "" ?> value="2">Masyarakat
                                                                </option>
                                                                <option <?php echo ($res->level == '3') ? "selected" : "" ?> value="3">Petugas
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
