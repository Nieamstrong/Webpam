...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar bg-gradient-primary sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- <?php if ($this->uri->segment('1') == 'petugas_laporan') { ?>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url('petugas_laporan'); ?>">
            ...
            <?php } ?>
            <?php if ($this->uri->segment('1') == 'petugas_reg') { ?>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url('petugas_reg'); ?>">
                        <i class="fas fa-fw fa-folder"></i>
