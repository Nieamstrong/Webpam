    ...
    <div class="col-lg-12" style="margin-top: 2%">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <?= form_open_multipart('admin_laporan/fpdf/'); ?>
                <div style="margin-right: -40px" class="mt-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover text-center" id="dataTable example1" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>NIK</th>
                                <th>Nama</th>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button style="float: right;" class="btn btn-danger mx-2 btn-sm" data-toggle="modal" data-target="#demo-default-hapus<?= $res->id_pengaduan; ?>">
                                ...
                                <!-- modal hapus -->
                                <div class="modal fade" id="demo-default-hapus<?= $res->id_pengaduan; ?>" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <p>Apakah anda yakin ingin menghapus ?</b>?</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-danger" href="<?php echo base_url('admin_laporan/hapuspengaduan/' . $res->id_pengaduan) ?>">Hapus Laporan</a>
                                            </div>
                                ...
                                <div class="modal fade" id="demo-default-edit<?= $res->id_user; ?>" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?= form_open_multipart('admin_laporan/editlaporan'); ?>
                                            <!--Modal body-->
                                            <div class="modal-body">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-12 text-dark font-weight-bold">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="status" class="control-label">Berikan Tanggapan</label>
                                                                <textarea type="text" name="status" class="form-control" id="status"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="modal fade" id="demo-default-tambah" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?= form_open_multipart('admin_beranda/tambah'); ?>
                <!--Modal body-->
                <div class="modal-body">
