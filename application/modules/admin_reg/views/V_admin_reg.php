<div id="page-content">
    ...
    <div class="col-md-9">
        <div class="card shadow-lg rounded-lg" id="demo-default-tambah" role="dialog" tabindex="-1" aria-labelledby="demo-default-card">
            <div class="card-dialog">
                <div class="card-content">
                    <!--card Update-->
                    <div class="card-header">
                        <h4 class="card-title font-weight-bold text-dark mt-4">Registrasi</h4>
                    </div>
